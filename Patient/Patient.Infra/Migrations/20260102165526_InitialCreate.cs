        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmergencyContact_Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    EmergencyContact_Relationship = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    EmergencyContact_Phone = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    EmergencyContact_Email = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patients_MRN_TenantId",
                table: "Patients",
                columns: new[] { "MRN", "TenantId" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patients_TenantId_IsActive_IsDeleted",
                table: "Patients",
